export const pet = [
  ...
  },
  {
    ...
    description:
      "Smile is essential oil based natural dry bath foam shampoo. It’s antimicrobial efficacy prevent skin infections, cleanses the skin coat and instantly deodrises the foul smell.",
    segment: "Pet",
    type: "Liquid",
    category: "Other Specialty",
  ...
  },
  {
    ...
    description:
      "FERAURI PET is a powerful hematinic for pets which contains Chelated forms of Ferrus glycinate and Copper glycinate with Cobalt, Cholecalciferol, Niacinamide, Pyridoxine, Vit E, Folic acid and GPP.",
    segment: "Pet",
    type: "Liquid",
    category: "Nutrition Supplement ,Other Specialty",
    packaging: "100 ml, 250 ml",
    ...
    composition: [
      ...
      "Chelated Copper glycinate 600 mg (eq. of 90 mg of Copper)",
      "Cobalt 10 mg (eq. of 4.5 mg of Cobalt)",
      "Cholecalciferol 25000 IU",
      "Niacinamide 300 mg",
      "Pyridoxine HCl 100 mg",
      "Vitamin E 250 IU",
      "Grape Polyphenol eq. to 175 IU Vitamin E activity",
      "Folic acid 15 mg"
    ],
    indications:
  ...
  },
  {
    ...
    description:
      "AURORD PET is a unique essential oils blend to prevent the respiratory distress due to severe cough and cold. It is a powerful mucolytic, expectorant and bronchodilator. Helps oxygen transition in lungs, decongests lungs for healthy respiration and builds immunity & boosts health of the pets.",
    segment: "Pet",
    type: "Liquid",
    category: "Other Specialty",
    packaging: "100 ml, 250 ml",
  ...
  {
    id: 10,
    name: "Curcumin and Tinospora cordifolia Extract",
    description:
      "CURINO PLUS PET is a synergistic combination of powerful extracts of Curcumin and Tinospora cordfolia enriched with bio-enhancer and metabolic potentiator technology. Bioenhancer and Metabolic potentiator technology enhances the permeability of intestinal microvilli and improves the absorption of Curcumin as well as Tinospora cordifolia flavonoids and also prevents it’s metabolic reduction through inhibition of P-gp, efflux pump, ATPase activity, CYP3A4, CYP3AG and UGT.",
    segment: "Pet",
    type: "Capsule",
    category: "Immunomodulator",
    packaging: "250 mg and 500 mg pack with 60 capsules",
  ...
  },
  {
    ...
    description:
      "IMMULAC PET is an orodispersible gut acting probiotic formulation enriched with a blend of 7 different probiotics for improving gut immunity and management of digestive disturbances like indigestion, diarrhea, constipation, IBS etc.",
    segment: "Pet",
    type: "Powder",
    ...
    composition: [
      ...
      "Blend of 7 Gut acting",
      "probiotics (5 billion live cells) 100 mg",
  ...
  {
    id: 15,
    name: "Curcumin Extract Liqui",
    description:
      "CURINO LIQUID PET is an advanced Curcumin liquid extract fortified with Bioenhancer techology to support immunity. It helps to boost the immune system which in turn reduces the onsets of your pet falling ill.",
    segment: "Pet",
    type: "Liquid",
    category: "Immunomodulator",
    packaging: "100 ml, 250 ml",
  ...
  },
  {
    ...
    description:
      "AURIGANDHA PET is a powerful blend of Withania somnifera extract enriched with bio - enhancer and metabolic potentiator technology.Bioenhancer and Metabolic potentiator technology enhances the permeability of intestinal microvilli and improves the absorption of Withanolides and also prevents it’s metabolic reduction through inhibition of P- gp, efflux pump, ATPase activity, CYP3A4, CYP3AG and UGT.",
    segment: "Pet",
    type: "Capsule",
  ...
  },
  {
    ...
    name: "Orodispersible Gut Acting Probiotic Food Supplement",
    description:
      "AUROLAC POWER PET is an orodispersible gut acting probiotic formulation enriched with a blend of 4 different probiotics for management of digestive disturbances like indigestion, diarrhea, constipation, IBS etc.",
    segment: "Pet",
    type: "Powder",
    category: "Digestive, Other Specialty",
    packaging: "10 X 2g sachet",
