...
export const speciesData = [
  {
    ...
    data: [
      { type: "Broilers, Chicks, Finisher, Grower", amount: "Weak Immunity", products: "MetaMune-VET (Immunomodulator), Aurivir-S, Aurivir-R, MetaBlu Plus, Aurimune" },
      { type: "Broilers, Chicks, Finisher, Grower", amount: "Liver Protectant", products: "Livauro Forte  AURILIV Vet, Natuchol" },
      { type: "Broilers, Chicks, Finisher, Grower", amount: "Weak Immunity", products: "MetaMune-VET (Immunomodulator), Aurivir-S, Aurivir-R, MetaBlu Plus, Aurimune" },
    ]
  },
  {
