const livestock_data = [
  ...
  },
  {
    ...
    description:
      "Estromin is unique blend of MHA chelated minerals, vitamins, bioactive chromium and grape polyphenols to optimize metabolic and reproductive functions. Estromin supplements essential nutrients to activate gonadal system and induce fertile estrus in bovines",
    segment: "Livestock",
    type: "Powder",
  ...
  {
    id: 29,
    name: "Topical Liquid for Lumpy Skin Disease Lesions",
    description:
      "Aurilum Topical is an topical application formula for the management of Lumpy Skin Disease lesions.",
    segment: "Livestock",
    type: "Liquid",
    category: "Other Specialty",
