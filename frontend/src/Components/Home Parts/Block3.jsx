  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 py-6 px-4">
      {block3Data.map((item, index) => (
        <div
          key={item.id}
          className="w-full max-w-xs md:max-w-sm h-[28rem] flex flex-col justify-between items-center bg-white rounded-xl shadow-md overflow-hidden transition-transform duration-300 hover:scale-105"
